...
const en = {
  ...
  editor: {
    ...
    props: {
      ...
      opacity: 'Opacity',
      ratio: 'Aspect ratio',
      pickColor: 'Pick a color (eyedropper)',
      font: 'Font',
      fontSize: 'Font size',
      style: 'Style',
      bold: 'Bold',
    ...
    brush: {
      ...
      color: 'Color',
      size: 'Size',
      merge: 'Keep strokes in the same layer',
      hint: 'Esc or switching tools starts a new layer on the next stroke.',
    },
    bg: {
      ...
      wand: 'Magic wand: click to erase a connected region',
      wandHint: 'Click the areas to erase. Only the region connected to the click is removed. Esc to finish.',
      erase: 'Eraser: drag to erase',
      eraseHint: 'Drag over the image to erase. Zoom in (Ctrl + scroll, Shift+2) for fine edges. Esc to finish.',
      restoreBrush: 'Restore brush: drag to bring back the original',
